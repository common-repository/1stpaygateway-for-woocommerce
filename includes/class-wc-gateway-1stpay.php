<?php
require_once 'invalidinputexception_1stpay.php';
...
class URLPaths_goe
{
    const URL_API = "https://secure.1stpaygateway.net/secure/RestGW/Gateway/Transaction/";
...
class Goe_messages
{
    ...
    const WC_GATEWAY_TITLE = "1stpaygateway";
    ...
    const LABEL_ENABLED = 'Enable 1stpaygateway plugin';
 ...
 * @version 1.3.0
 */
class WC_Gateway_1stpay extends WC_Payment_Gateway_CC {
    ...
    function get_customer_billing_checkout($order) {
        ...
        return array (
            ...
            'ownerCity'         => $order->get_billing_city(),
            'ownerCountry'      => $order->get_billing_country(),
            'ownerState'        => $order->get_billing_state(),
            'ownerStreet'       => $order->get_billing_address_1(),
            'ownerStreet2'      => $order->get_billing_address_2(),
    ...
    function get_card_expiry() {
        ...
        if (
			...
			$ExpArr = array("cardExpMonth" => $cardExpMonth, 
    ...
    function get_card_cvc($forSavedCard=false) {
     ...
     */
     public function form() {
        ...
        wp_enqueue_script( '1stpay-form-handler', plugins_url('/1stpay-form-handler.js',__FILE__) );
...
class RestGateway {
    ...
    public function __construct() {
        ...
        $this->version = "1.0.0";
        $this->apiUrl = WC_Gateway_1stpay::$apiURL;
        $this->Result = array();
        $this->status = "";
